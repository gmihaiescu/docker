...
RUN perl -c -I /opt/gt-download-upload-wrapper/gt-download-upload-wrapper-2.0.10/lib /opt/vcf-uploader/vcf-uploader-2.0.4/gnos_upload_vcf.pl && \
    ...
    perl -c -I /opt/gt-download-upload-wrapper/gt-download-upload-wrapper-2.0.10/lib /opt/vcf-uploader/vcf-uploader-2.0.4/get_donors_by_elastic_search.pl && \
    perl -c -I /opt/gt-download-upload-wrapper/gt-download-upload-wrapper-2.0.10/lib /opt/vcf-uploader/vcf-uploader-2.0.4/synapse_upload_vcf.pl
