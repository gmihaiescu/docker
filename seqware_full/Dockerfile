...
RUN git checkout 6506dc22730fc3bda72595419df9856232fdc7a9
ENV HOSTNAME master
...
RUN cat /tmp/tmpfile > /etc/hosts && ansible-playbook seqware-install.yml -c local --extra-vars "seqware_version=1.1.0-rc.1 docker=yes"
...
RUN cd seqware-bag && git checkout 6506dc22730fc3bda72595419df9856232fdc7a9
